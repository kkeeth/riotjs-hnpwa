var riothn = (function() {
      ...
      function _each(dom, parent, expr) {
        ...
        expr.update = function updateEach() {
          ...
          each(items, function(_item, i) {
            ...
            var doReorder =
              mustReorder && typeof _item === T_OBJECT && !hasKeys;
  ...
  riot$1.tag2(
    "app",
    '<div id="header"> <a id="yc" href="http://www.ycombinator.com"> <img src="https://news.ycombinator.com/y18.gif"> </a> <h1><a href="#">Hacker News</a></h1> <span class="source"> Built with <a href="https://muut.com/riotjs/" target="_blank">Riot.js</a> | <a href="https://github.com/txchen/riot-hn" target="_blank">Source</a> </span> </div> <div>current view: {currentview}</div> <div id="placeholder"></div>',
    "",
    "",
    function(opts) {
      var self = this;
      ...
      this.loadView = function(viewName, id) {
        ...
        riot$1.mountTo(document.getElementById("hnview"), viewName, id);
        self.update();
      }.bind(this);
      ...
      riot$1.route(self.studyRoute);
      this.on("mount", function() {
        riot$1.route.exec(self.studyRoute);
      });
    }
  );

  var riot$3 = (riot$2 && riot$1) || riot$2;
